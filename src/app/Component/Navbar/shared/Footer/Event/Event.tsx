  ...
  return (
    ...
    <div className="bg-slate-100 py-24">
      <div className="max-w-[1500px] m-auto py-16 px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 justify-center items-center">
          {events.map((event, index) => (
            <div key={index} className="rounded-2xl overflow-hidden text-center max-w-xs sm:max-w-sm mx-auto">
              {/* Responsive Image Container */}
              <div className="relative overflow-hidden rounded-t-full w-full aspect-[4/5] border-[20px] border-white shadow-lg">
                <Image
                  src={event.image}
                  alt={event.title}
                  fill
